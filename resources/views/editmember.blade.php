...
@if (session()->has('success_message'))
          ...
          <!-- /.box-header -->
          <div class="box-body">
             <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="{{route('updatemember',$member->nis)}}">
           ...
           <div class="form-group row">
                  <label for="inputPassword" class="col-sm-2 col-form-label" align="right">NIS</label>
                      <div class="col-sm-10">
                            <input type="text" class="form-control" id="nis" name="nis" placeholder="" value="{{ $member->nis }}">
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-2 col-form-label" align="right">Nama</label>
                    <div class="col-sm-10">
                          <input type="text" class="form-control" id="nama" name="nama" placeholder="" value="{{ $member->name }}">
             <p class="error text-center alert alert-danger hidden"></p>
                       </div>
            </div>
            ...
            <div class="form-group row">
                <label for="inputPassword" class="col-sm-2 col-form-label" align="right">No HP</label>
                    <div class="col-sm-10">
                          <input type="number" class="form-control" id="phone" name="phone" placeholder="" value="{{ $member->phone }}">
             <p class="error text-center alert alert-danger hidden"></p>
                       </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  ...
                  <textarea id="alamat" name="alamat" value="{{ $member->address }}" rows="5" cols="142">
                    {{ $member->address }}
                  </textarea>
                  <p class="error text-center alert alert-danger hidden"></p>
                </div>
